...
PROJECTS_HEAD = (
    ...
    'Степень защиты',
    'Кол-во изделий',
    'Себестоимость комплектующих EUR с НДС',
    'Программирование, EUR',
    'Упаковка',
    'Планируемая себестоимость РК EUR с НДС',
    '',
    'Стоимость сборки за изделия EUR с НДС',
    '',
    'Планируемый GM по изделию',
    '',
    'Стоимость за единицу EUR с НДС',
    'Стоимость изделий EUR с НДС',
    'Планируемая себестоимость + расходники на кол-во изделий EUR с НДС',
)

PROJECTS_HEAD_PRICING = (
    ('Полная стоимость проекта EUR с НДС:', 15),
    ('Планируемый бюджет ПРОИЗВОДСТВА_EUR с НДС:', 10),
    ('Планируемая прибыль ПРОЕКТА_EUR с НДС:', 12),
    ('Планируемая себестоимость + РК_EUR с НДС', 16),
)
